...
The prediction head of ViT is replaced with a FCN head which outputs the classifier scores, prediction of the size of the bounding box, and the prediction of the center of the bounding box for each of the search region patches input to the model.
...
![Details of Vision Transformer model variants](image-1.png)
...
![Structure of the encoder layer](image-2.png)
...
![The result of convolutions](<nn (1)-cropped.svg>)
